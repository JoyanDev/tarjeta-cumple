...
export const EVENT_DATE = new Date('2026-08-17T16:00:00-05:00');

export const EVENT_DATE_LABEL = '17 agos';
export const EVENT_TIME_LABEL = '5:00 PM';
...
export const EVENT_MAPS_QUERY = 'Santa Clara, Lima, Perú';
